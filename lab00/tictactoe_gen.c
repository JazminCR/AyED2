...
#define N 5 // NxN es la dimension del board (asignar valor deseado a N)
...
bool check_row (int pos,char board[N][N],char a) {
    bool res = true;
    for (int i = 0; i < (N-1) ; i++) {
...
bool check_col (int pos, char board[N][N],char a) {
    bool res = true;
    for (int i = 0; i<(N - 1 ) ; i++) {
...
bool check_fdiag (char board[N][N],char a) {
    bool res = true;
    for (int i =0; i<(N-1); i++) {
...
bool check_sdiag (char board[N][N],char a){
    bool res = true; int i = 0; int j = N-1;
    while (i< N-1) {
...
bool check_winner (char a ,char board[N][N]) {
    bool res= false;
